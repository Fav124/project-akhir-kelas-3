...
@section('content')
    ...
    <div class="mb-4">
        ...
        <small class="text-muted">Tambahkan kelas baru</small>
    </div>
    ...
    <div class="card border-0 shadow-sm" style="max-width: 600px;">
        <div class="card-body">
            <h5 class="fw-bold mb-4">
                <i class="bi bi-pencil-square me-2 text-primary"></i> Form Data Kelas
            </h5>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control @error('nama_kelas') is-invalid @enderror" id="nama_kelas"
                            placeholder="Contoh: Kelas 1 A" name="nama_kelas" value="{{ old('nama_kelas') }}" required>
                    </div>
                    @error('nama_kelas')
