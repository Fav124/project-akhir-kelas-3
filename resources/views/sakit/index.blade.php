...
<script>
    $(document).ready(function() {
        ...
        function fetchData(page = 1, search = '') {
            $.ajax({
                url: "{{ route('sakit.index') }}" + "?page=" + page + "&search=" + search,
